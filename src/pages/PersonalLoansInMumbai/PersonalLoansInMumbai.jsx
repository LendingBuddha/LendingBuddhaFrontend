...
import './PersonalLoansInMumbai.css'; // Ensure you import the CSS file

const PersonalLoansInMumbai = () => {
  return (
    <div className="personal-loans-mumbai">
      <header className="header">
        <h1 className="heading">Personal Loans in Mumbai</h1>
        {/* <img src="path-to-your-image.jpg" alt="Mumbai" className="header-image" /> */}
      </header>

      <section className="intro">
        <p>
          Mumbai, India's financial and commercial capital and the heart of the Indian glamour and film industry. It's considered India's biggest metropolitan city and also popularly known as the city which never sleeps.
        </p>
        <p>
...
export default PersonalLoansInMumbai;
