...
import './PersonalLoanBangalore.css'; // Ensure you import the CSS file

const PersonalLoanBangalore = () => {
    return (
        <div className="personal-loans-mumbai">
            <header className="header">
                <h1 className="heading">Personal Loans in Hydrabad</h1>
                {/* <img src="path-to-your-image.jpg" alt="Mumbai" className="header-image" /> */}
            </header>

            <section className="intro">
            <p>Bangalore (Bengaluru), also known as the Garden City of India, is one of the historic cities in India where you can find mesmerizing and stunning places like Lalbagh Garden, Cubbon Park, Bannerghatta National Park, Tipu Sultan's Summer Palace. It’s also home to heavy industries, public sector companies, software companies, telecommunications, aerospace, and defense organizations.</p>
            <p>As one of India's largest cities and a growing metropolis, Bangalore is renowned for its medical tourism, world-class universities, and colleges. It's the home of some of the best tech companies and is often referred to as the Silicon Valley of India.</p>
            </section>

            <section className="purpose">
                <h2 className="section-title">Here are some of the reasons why people take personal loans in Hyderabad.</h2>
                <ul>
                    <li>Financing home improvements</li>
                    <li>Improving credit score</li>
                    <li>Setting up a side business</li>
                    <li>Meeting emergency medical expenses</li>
            ...
            <section className="purpose">
                <h2 className="section-title">In order to get a personal loan in Delhi, you need to satisfy the below mentioned criteria</h2>
                <ul>
...
export default PersonalLoanBangalore;
